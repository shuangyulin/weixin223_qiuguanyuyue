<template>
  <el-breadcrumb class="app-breadcrumb" separator="|" style="height:50px;backgroundColor:rgba(80, 166, 203, 0.92);borderRadius:0px;padding:0px 20px 0px 20px;boxShadow:0px 0px 0px #f903d4;borderWidth:3px;borderStyle:dashed ;borderColor:rgba(255, 255, 255, 1);">
